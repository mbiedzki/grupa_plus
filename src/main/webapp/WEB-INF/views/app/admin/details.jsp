...
<span>
    ...
    <form:form method="post" modelAttribute="user">
        ...
        Administrator: <form:checkbox path="admin"/><form:errors path="admin" cssClass="error"/><br><br>
        Obsługa HR: <form:checkbox path="hr"/><form:errors path="hr" cssClass="error"/><br><br>

        Nowe hasło:<form:password path="password"/>

        <hr>

        <input type="submit" value="Zapisz"><form:errors path="admin" cssClass="error"/><br><br>
