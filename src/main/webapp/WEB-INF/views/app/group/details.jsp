...
<div class="w3-panel">
    ...
    <form:form method="post" modelAttribute="group">
        ...
        <span style='width: 15%; display: inline-block'>Nazwa:</span>
        ...
        <form:options items="${companies}" itemLabel="name" itemValue="id"/></form:select>
        <form:errors path="company" cssClass="error"/>
        <hr>

        <span style='width: 15%; display: inline-block'>Produkt:</span>
        <form:select cssStyle="width: 30%" path="product">
            <form:option value="0" label="--Wybierz produkt--"/>
            <form:options items="${products}" itemLabel="name" itemValue="id"/></form:select>
