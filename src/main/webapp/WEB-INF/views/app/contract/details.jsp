...
<div class="w3-panel">
    ...
    <form:form method="post" modelAttribute="contract">
            ...
            <span style='width: 15%; display: inline-block'>Ubezpieczony: </span><form:select cssStyle="width: 30%" path="insured">
        ...
        <form:errors path="insured" cssClass="error"/>
            ...
            <span style='width: 15%; display: inline-block'>Uposażony: </span><form:select cssStyle="width: 30%" path="beneficiary">
        ...
        <form:errors path="beneficiary" cssClass="error"/>
            ...
            <span style='width: 15%; display: inline-block'>Grupa: </span><form:select cssStyle="width: 30%" path="contractGroup">
