...
<div class="w3-panel">
    ...
    <form:form method="post" modelAttribute="product">
        ...
        <span style='width: 17%; display: inline-block'>Nazwa:</span>
        <form:input cssStyle="width: 40%" path="name"/>
        <form:errors path="name" cssClass="error"/><br><br>
        <hr>

        <span style='width: 17%; display: inline-block'>Umowa główna: </span>
        <form:select cssStyle="width: 40%" path="mainCover">
        ...
        <span style='width: 17%; display: inline-block'>Umowy dodatkowe: </span>
        <form:select cssStyle="width: 40%" path="riders" multiple="true">
